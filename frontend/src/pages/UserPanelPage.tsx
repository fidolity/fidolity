...
import { DollarSign, Activity, Package, Copy, Check } from 'lucide-react';
      ...
      <div className="pt-32 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            ...
            {walletAddress ? (
              <div className="bg-white rounded-lg border border-gray-200 p-4 hover:border-gray-300 transition-all max-w-md">
                <div className="flex items-center justify-between">
                  <div>
                    <div className="font-everett-mono text-sm text-gray-900 mb-1">
                      {walletAddress}
                    </div>
                  ...
                  <button
                    onClick={handleCopy}
                    className="p-2 hover:bg-gray-100 rounded transition-all group"
                    title="Copy address"
                  >
                    {copied ? (
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-4 max-w-md">
                <div className="flex items-center justify-between">
                  <div>
                    <div className="font-everett-mono text-sm text-gray-600 mb-1">
                      No wallet connected
                    </div>
                    <p className="text-xs text-gray-500 font-everett-mono">
