      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full">
        <div className="flex justify-between items-center h-full gap-4">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <a href="https://x.com/fidolitydotfun" className="text-white hover:text-white/80 transition-colors flex-shrink-0">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
              </svg>
            </a>

            <a href="https://github.com/fidolity" className="text-white hover:text-white/80 transition-colors flex-shrink-0">
              <Github size={20} />
            </a>
          </div>
        </div>
