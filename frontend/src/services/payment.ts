...
export class PaymentService {
  ...
  static initialize(rpcEndpoint?: string) {
    const endpoint = rpcEndpoint || import.meta.env.VITE_HELIUS_RPC_URL || 'https://mainnet.helius-rpc.com/?api-key=b949b8c4-ffbd-40f7-b74c-1daf99b6e23a';
